...
ns_radius clientadd localhost secret
...
ns_radius dictadd Acct-Terminate-Cause 49 0 integer User-Request 1 Lost-Carrier 2 Lost-Service 3 Idle-Timeout 4 Session-Timeout 5 Admin-Reset 6 Admin-Reboot 7 Port-Error 8 NAS-Error 9 NAS-Request 10 NAS-Reboot 11 Port-Unneeded 12 Port-Preempted 13Port-Suspended 14 Service-Unavailable 15 Callback 16 User-Error 17 Host-Request 18
...
ns_radius dictadd Menu 1001 0 string
ns_radius dictadd Termination-Menu 1002 0 string
ns_radius dictadd Prefix 1003 0 string
ns_radius dictadd Suffix 1004 0 string
ns_radius dictadd Group 1005 0 string
ns_radius dictadd Crypt-Password 1006 0 string
ns_radius dictadd Connect-Rate 1007 0 integer
